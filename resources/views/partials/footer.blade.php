<footer class="container py-5">
    <div class="row">
        <div class="col-12 col-md">
            ...
            <small class="d-block mb-3 text-muted">&copy; Copyright {{ Carbon\Carbon::now()->format('Y') }} all rights
                reserved</small>
            <small class="d-block mb-3 text-muted">by {{ config('app.name', 'James Company') }}</small>
        </div>
